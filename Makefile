...
JSON_FORMATTER_SOURCES := tools/format/format.cpp tools/format/format_main.cpp src/text_json.cpp
CHKJSON_SOURCES := src/chkjson/chkjson.cpp src/text_json.cpp

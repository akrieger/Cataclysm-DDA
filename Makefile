...
$(BUILD_PREFIX)zstd.a: $(filter third-party/zstd,$(OBJS))
	$(AR) rcs $(AR_FLAGS) $(BUILD_PREFIX)zstd.a

$(ZZIP_BIN): $(ZZIP_SRCS) $(BUILD_PREFIX)zstd.a
	$(CXX) $(CXXFLAGS) -MMD -MP $(ZZIP_SRCS) -lzstd -isystem src/third-party -l$(BUILD_PREFIX)zstd.a -o $(ZZIP_BIN)

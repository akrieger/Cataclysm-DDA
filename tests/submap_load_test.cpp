...
static auto submap_empty = JsonValue::fromString( submap_empty_ss );
static auto submap_terrain_rle = JsonValue::fromString( submap_terrain_rle_ss );
static auto submap_furniture = JsonValue::fromString( submap_furniture_ss );
static auto submap_trap = JsonValue::fromString( submap_trap_ss );
static auto submap_rad = JsonValue::fromString( submap_rad_ss );
static auto submap_item = JsonValue::fromString( submap_item_ss );
static auto submap_field = JsonValue::fromString( submap_field_ss );
static auto submap_graffiti = JsonValue::fromString( submap_graffiti_ss );
static auto submap_spawns = JsonValue::fromString( submap_spawns_ss );
static auto submap_vehicle = JsonValue::fromString( submap_vehicle_ss );
static auto submap_construction = JsonValue::fromString( submap_construction_ss );
static auto submap_computer = JsonValue::fromString( submap_computer_ss );
static auto submap_cosmetic = JsonValue::fromString( submap_cosmetic_ss );

...
2. Create a file called `Directory.Build.props` at the root of the Cataclysm-DDA folder with the following contents.
  - If you installed a release directly from LLVM releases, use these settings
```
<Project>
  <PropertyGroup>
...
```
  ...
  - If you installed LLVM through the Visual Studio Installer, then use these contents.
```
<Project>
  <PropertyGroup>
    <CDDA_ENABLE_THIN_ARCHIVES>true</CDDA_ENABLE_THIN_ARCHIVES>

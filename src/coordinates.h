...
struct quotient_remainder_tripoint {
    ...
    template < typename quotient_tripoint_ob = std::enable_if_t <
                   !std::is_same_v<quotient_type_tripoint, quotient_type_tripoint_ob>, quotient_type_tripoint_ob >>
    operator std::tuple<quotient_tripoint_ob &, remainder_type &>() {
        return std::tie( static_cast<quotient_tripoint_ob &>( quotient_tripoint ), remainder );
    }
    template < typename quotient_ob = std::enable_if_t <
                   !std::is_same_v<quotient_type, quotient_type_ob>, quotient_type_ob >>
    operator std::tuple<quotient_ob &, remainder_type_tripoint &>() {
        return std::tie( static_cast<quotient_ob &>( quotient ), remainder_tripoint );
    }

    template < typename remainder_ob = std::enable_if_t <
                   !std::is_same_v<remainder_type, remainder_type_ob>, remainder_type_ob >>
    ...
    template < typename remainder_tripoint_ob = std::enable_if_t <
                   !std::is_same_v<remainder_type_tripoint, remainder_type_tripoint_ob>, remainder_type_tripoint_ob >>

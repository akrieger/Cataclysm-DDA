...
class map
{
    ...
    public:
        ...
        */
        ...
        bool partial_con_remove( const tripoint_bub_ms &p );
        bool partial_con_remove_no_vision_for_testing( const tripoint_bub_ms &p );
        partial_con *partial_con_at( const tripoint_bub_ms &p );
        // Traps
        void trap_set( const tripoint_bub_ms &p, const trap_id &type );

    private:
        bool partial_con_remove_impl( const tripoint_bub_ms &p );
    public:

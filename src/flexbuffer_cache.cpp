...
flexbuffer_cache::flexbuffer_cache( fs::path cache_directory, fs::path root_directory )
{
    disk_cache_ = flexbuffer_disk_cache::init_from_folder( std::move( cache_directory ),
